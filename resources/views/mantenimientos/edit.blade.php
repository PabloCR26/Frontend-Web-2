                                ...
                                <form action="{{ route('mantenimientos.update', $mantenimiento['id']) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <small class="text-muted">Se asigna automáticamente si se deja vacío.</small>
                                        </div>
                                    ...
                                    <div id="closeAlert" class="alert alert-warning d-none">
                                        ...
                                        <strong>¡Atención!</strong> Al cerrar este mantenimiento, el vehículo volverá a estar disponible.
                                    </div>
