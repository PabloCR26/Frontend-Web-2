...
<head>
    <meta charset="utf-8" />
    <title>RentaCar | Nueva Ruta</title>
        ...
        <div class="app-content-header">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Crear Nueva Ruta</h3>
                    </div>
            ...
            <div class="container-fluid">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card card-info card-outline shadow-sm border-0">
                                <div class="card-header">
                                    <h5 class="mb-0 fw-bold">Información de la Ruta</h5>
                                </div>
                                        ...
                                        <div class="row g-4">
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="name" class="form-control" 
                                                           value="{{ old('name') }}" placeholder="Ej. Ruta de Logística Norte" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="start_point" class="form-control" 
                                                           value="{{ old('start_point') }}" placeholder="Ej. Sede Central (San José)" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="end_point" class="form-control" 
                                                           value="{{ old('end_point') }}" placeholder="Ej. Sucursal Ciudad Quesada" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="description" class="form-control" rows="3" required
                                                          placeholder="Ej. Distribución de suministros semanal.">{{ old('description') }}</textarea>
                                            </div>
                                        </div>
                ...
                @else
                    <div class="alert alert-danger shadow-sm">
                        <i class="bi bi-shield-lock-fill me-2"></i> No tienes permiso para registrar rutas.
                    </div>
                @endcan
            </div>
        </div>
